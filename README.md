 ...
 * Follow the universal (Use `all lowercase with snake_case — no spaces, no hyphens, no uppercase`) tagging standard to ensure compatibility across CSP's without any transformation. 
 * `all lowercase`  
