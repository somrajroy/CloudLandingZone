 ...
 * Follow the universal (Use `Use all lowercase with snake_case — no spaces, no hyphens, no uppercase`) tagging standard to ensure compatibility across AWS, Azure, and GCP without any transformation. This makes tagging portable and automation-friendly across AWS, Azure, and GCP & works natively in all three clouds without modification.
